...
def add_transaction(date, description, category, amount, conn):
    try:
        amount = float(amount)
...
def delete_transaction(transaction_number, conn): 
    try:
...
def update_transaction(transaction_number, date, description, category, amount, conn): 
    try:
        transaction_number = int(transaction_number)
        amount = float(amount)
        cursor = conn.cursor()
